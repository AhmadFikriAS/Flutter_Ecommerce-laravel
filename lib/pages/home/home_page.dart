...
import 'package:flutter_laravel/widgets/product_tile.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ProductProvider proudctProvider = Provider.of<ProductProvider>(context);
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              Row(
                children: proudctProvider.products
                    .map(
